...
define([
    ...
    $.widget('mage.ameexGallery', $.mage.ameexGallery, {
        options: {
        ...
        _initDialog: function () {
	        ...
	        $dialog.on('change', '[data-role="image-alt"]', function (e) {
                var target = $(e.target),
                    targetName = target.attr('name'),
                    desc = target.val(),
                    imageData = $dialog.data('imageData');
            ...
            // Here add your hidden fields value update functionality and so on
            // $dialog.on('change', '[data-role="new-field"]', function (e) {
            //var target = $(e.target),
            //        targetName = target.attr('name'),
            //        desc = target.val(),
            //        imageData = $dialog.data('imageData');
